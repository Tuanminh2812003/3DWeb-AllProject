...
function Custom() {
	...
	const [currentModelPath1, setCurrentModelPath1] = useState(
		"/NTST/Question 1.glb"
	);
	const [currentModelPath2, setCurrentModelPath2] = useState(
		"/NTST/Question 2.glb"
	);
	const [currentModelPath3, setCurrentModelPath3] = useState(
		"/NTST/Question 3.glb"
	);
	...
	const [popUpAboutTheExhibition, setPopUpAboutTheExhibition] =
		useState(false);
	...
	const handlePictureClick = useCallback(
		(position, rotation, imageUrl, model, info, video) => {
			...
			setPromptTimeout(
				setTimeout(() => setShowDetailsPrompt(false), 5000)
			); // Ẩn prompt sau 5 giây
		},
	...
	return (
		<>
					...
					{freeExploration && (
						<div className="controler">
							...
							<div className="bottom">
								<button
									onMouseDown={() =>
										handleControl("rotateLeft", true)
									}
									onMouseUp={() =>
										handleControl("rotateLeft", false)
									}
									onTouchStart={() =>
										handleControl("rotateLeft", true)
									}
								...
								<button
									onMouseDown={() =>
										handleControl("rotateRight", true)
									}
									onMouseUp={() =>
										handleControl("rotateRight", false)
									}
									onTouchStart={() =>
										handleControl("rotateRight", true)
									}
					...
					{showPuzzleGame1 && (
						<div className="popup-overlay">
							<div className="popup-content">
								...
								<PuzzleGame
									onComplete={handlePuzzle1Complete}
								/>
							</div>
						</div>
					)}
					{showPuzzleGame2 && (
						<div className="popup-overlay">
							<div className="popup-content">
								...
								<PuzzleGame
									onComplete={handlePuzzle2Complete}
								/>
							</div>
						</div>
					)}
					{showPuzzleGame3 && (
						<div className="popup-overlay">
							<div className="popup-content">
								...
								<PuzzleGame
									onComplete={handlePuzzle3Complete}
								/>
							</div>
						</div>
					)}
			...
			{/* Respondsive */}
			<ResizeHandler
				updateItemsForScreenSize={updateItemsForScreenSize}
			/>
			{/* Respondsive */}
