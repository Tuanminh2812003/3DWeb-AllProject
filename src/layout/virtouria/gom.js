...
const modelsConfig = useMemo(
    ...
    const [cameraPosition, setCameraPosition] = useState(new Vector3(1, 1.6, 1));
        ...
        <>
            <CameraProvider>
                <div className='main'>
                    ...
                    />
                    <PopUpHowToMove open={showHowToMove} handleClose={handleCloseHowToMove} link="https://web-xr-livid.vercel.app/virtouria/gom"/>
