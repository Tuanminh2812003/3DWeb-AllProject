...
const modelsConfig = useMemo(
    ...
    const [cameraPosition, setCameraPosition] = useState(new Vector3(0, 1.6, 15));
        ...
        <>
            <CameraProvider>
                <div className='main'>
                    ...
                    />
                    <PopUpHowToMove open={showHowToMove} handleClose={handleCloseHowToMove} link="https://web-xr-livid.vercel.app/virtouria/30thang4" />
