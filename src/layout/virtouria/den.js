...
const modelsConfig = useMemo(
    () => [
        ...
        {
            path: "/virtouria/den/Firebug.glb",
            position: [0, -1.8, 0],
            rotation: [0, 0, 0],
            scale: [1, 1, 1],
            clickable: false,
        ...
        {
            path: "/virtouria/den/Hanging latern.glb",
            position: [0, -1.8, 0],
            rotation: [0, 0, 0],
            scale: [1, 1, 1],
            clickable: false,
        ...
        {
            path: "/virtouria/den/Moutain.glb",
            position: [0, -1.8, 0],
            rotation: [0, 0, 0],
            scale: [1, 1, 1],
            clickable: false,
        ...
        {
            path: "/virtouria/den/Sky Lantern.glb",
            position: [0, -1.8, 0],
            rotation: [0, 0, 0],
            scale: [1, 1, 1],
            clickable: false,
        ...
        {
            path: "/virtouria/den/Steel Circle_achivement.glb",
            position: [0, -1.8, 0],
            rotation: [0, 0, 0],
            scale: [1, 1, 1],
            clickable: false,
        ...
        {
            path: "/virtouria/den/Table game.glb",
            position: [0, -1.8, 0],
            rotation: [0, 0, 0],
            scale: [1, 1, 1],
            clickable: false,
    ...
    const [cameraPosition, setCameraPosition] = useState(new Vector3(0, 1.6, 2));
        ...
        <>
            <CameraProvider>
                <div className='main'>
                    ...
                    />
                    <PopUpHowToMove open={showHowToMove} handleClose={handleStartVideo} link="https://web-xr-livid.vercel.app/virtouria/denlong" />
                    ...
                    {showIntroVideo && (
                        <div className="video-overlay">
                            <video ref={videoRef} className="intro-video" onEnded={handleCloseVideo}>
                                <source src="/virtouria/den/Sky Lantern demo game.mp4" type="video/mp4" />
